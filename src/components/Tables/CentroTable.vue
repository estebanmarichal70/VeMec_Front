<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input v-model="listQuery.title" placeholder="Nombe de Centro" style="width: 200px;" class="filter-item"
                @keyup.enter.native="handleFilter"/>

      <el-select v-model="listQuery.codigo" placeholder="Codigo" clearable class="filter-item" style="width: 130px">
        <el-option v-for="item in list" :key="item.id" :label="item.codigo" @click="handleFilter(item.codigo)"
                   :value="item.codigo"/>
      </el-select>
    ...
    >
      ...
      <el-table-column label="Nombre" align="center" min-width="150px">
        <template slot-scope="{row}">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      <el-form ref="dataForm" :rules="rules" :model="centro" label-position="left"
        ...
        <el-form-item>
          <el-select v-model="centro.codigo" class="filter-item" placeholder="Departamento">
            <el-option v-for="item in codigos" :key="item.key" :label="item.display_name"
                       :value="item.key"/>
          </el-select>
        </el-form-item>
    ...
    <el-dialog title="Estas seguro de que deseas eliminar el centro?" :visible.sync="dialogDeleteVisible">
      ...
      <el-form ref="deleteForm" :rules="deleteRules" :model="deleteConfirmation" label-position="left"
               style="width: 400px; margin-left:50px;">
